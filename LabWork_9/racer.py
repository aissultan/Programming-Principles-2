...
NUM_OF_COINS = 0 # счетсчик для машин 

screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT)) # установление экрана

pygame.display.set_caption("Aisultan's racer game") # название игры
...
bg = pygame.image.load("Resources//AnimatedStreet.png") # фон игры
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('Resources//goldcoin.png')
...
class Treasure(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('Resources//treasure.png')
